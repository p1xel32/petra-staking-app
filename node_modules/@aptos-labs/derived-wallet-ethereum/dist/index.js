...
__export(index_exports, {
  ...
  EIP1193PersonalSignature: () => EIP1193PersonalSignature,
  EIP1193SiweSignature: () => EIP1193SiweSignature,
...
var _EIP1193PersonalSignature = class _EIP1193PersonalSignature extends import_ts_sdk2.Signature {
...
var EIP1193DerivedPublicKey = class _EIP1193DerivedPublicKey extends import_ts_sdk3.AccountPublicKey {
  ...
  verifySignature({ message, signature }) {
    ...
    const recoveredAddress = (0, import_ethers.verifyMessage)(messageBytes, siweSignature);
  ...
  serialize(serializer) {
    ...
    serializer.serializeFixedBytes(
      import_ts_sdk3.Hex.fromHexInput(this.ethereumAddress).toUint8Array()
    );
  ...
  static deserialize(deserializer) {
    ...
    const ethereumAddress = import_ts_sdk3.Hex.fromHexInput(
