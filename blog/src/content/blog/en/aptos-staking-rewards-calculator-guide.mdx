...
* Your chosen validator, [aptcore.one](https://aptcore.one), has a **4%** commission (or 0.04).

`Gross Annual Rewards = 1,000 APT * 0.07 = 70 APT`
`Commission Paid = 70 APT * 0.04 = 2.8 APT`
`Your Net Annual Rewards = 70 APT - 2.8 APT = 67.2 APT`
...
`Net Epoch Reward = 0.01598 * (1 - 0.04) ≈ 0.01534 APT`

Now, for the next epoch, your new principal stake will be `1000 + 0.01534 = 1000.01534 APT`. While this seems like a tiny increase, repeating this process 4,380 times a year is what makes the final APY (Annual *Percentage Yield*) higher than a simple APR (Annual *Percentage Rate*).
