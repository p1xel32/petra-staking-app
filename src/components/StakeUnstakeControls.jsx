...
function StakeUnstakeControls({ account, onTransactionSuccess }) {
  ...
  const [txResult, setTxResult] = useState(null); // Stores { type: 'success' | 'error', message: string }
  ...
  const handleWithdraw = () => {
   ...
   return (
    // The parent div in App.jsx provides the card styling
    <div className="w-full">
      ...
      <div className="mb-6">
        ...
        <div className="relative">
          ...
          />
          {/* Optional: Add MAX button here */}
        </div>
      </div>

      {/* Stake/Unstake Buttons */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        {/* Stake Button - Primary Action (Bright Gradient) */}
        <button
          onClick={handleStake}
        ...
        {/* Unstake Button - Secondary Action (Outline Style with Accent) */}
        <button
      ...
      <div className="border-t border-gray-700 pt-6 mt-6">
         ...
         {/* Withdraw Button - Keeping Red/Pink Gradient */}
         <button
