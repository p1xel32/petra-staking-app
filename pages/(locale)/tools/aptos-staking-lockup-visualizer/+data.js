...
export async function data(pageContext) {
    try {
        ...
        const stakingConfig = { recurring_lockup_duration_secs: String(stakingConfigRes.data.recurring_lockup_duration_secs) };
        ...
        console.error("API Error in lockup-visualizer/+data.js:", error);
        return { stakingConfig: null, epochTiming: null, validatorPoolInfo: null, error: error.message };
    }
}