    ...
    <>
      ...
      <div className="w-full max-w-3xl mx-auto py-8 px-4 sm:py-12 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-12">
          <Title level={1} className="!text-3xl sm:!text-4xl font-bold !mb-3 tracking-tight !text-white">Interactive Aptos (APT) Staking APY Calculator</Title>
          <Paragraph className="text-gray-300 text-base sm:text-lg max-w-xl mx-auto">Easily calculate your potential Aptos (APT) staking rewards with aptcore.one's free APY calculator. Input stake amount & see estimated daily, monthly, and yearly earnings.</Paragraph>
        </div>
